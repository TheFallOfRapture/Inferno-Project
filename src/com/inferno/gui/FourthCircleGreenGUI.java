...
public class FourthCircleGreenGUI extends TetrisGUI {
    ...
    public void load() {
        ...
        TextElement b = TextElement.centerXWithin("You got the green ending!", "fonts/Ubuntu/Ubuntu-Regular.ttf", 32, new Color(0, 1, 0), panel);
        ...
        TextElement bbb = new TextElement("You got the green ending!", "fonts/Ubuntu/Ubuntu-Regular.ttf", 32, new Color(0, 1, 0), bb, -40);
