 ...
 */
public class FourthCircleBlueGUI extends TetrisGUI {
    public FourthCircleBlueGUI(Game game, int width, int height, float worldSize) {
        super(game, width, height, worldSize, 0);
    }

    public void load() {
        addElement(new Panel(new Vector2f(0, 0), new Vector2f(width, height), new Color(0, 0, 1), new Texture("textures/mass effect 3.jpg")));
        ...
        TextElement b = TextElement.centerXWithin("You got the blue ending!", "fonts/Roboto Mono/RobotoMono-Regular.ttf", 32, new Color(0, 0, 1), panel);
        ...
        TextElement bbb = new TextElement("You got the blue ending!", "fonts/Roboto Mono/RobotoMono-Regular.ttf", 32, new Color(0, 0, 1), bb, -40);
