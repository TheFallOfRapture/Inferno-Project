...
public class FourthCircleBlueGUI extends TetrisGUI {
    ...
    public void load() {
        ...
        TextElement b = TextElement.centerXWithin("You got the blue ending!", "fonts/Ubuntu/Ubuntu-Regular.ttf", 32, new Color(0, 0, 1), panel);
        ...
        TextElement bbb = new TextElement("You got the blue ending!", "fonts/Ubuntu/Ubuntu-Regular.ttf", 32, new Color(0, 0, 1), bb, -40);
